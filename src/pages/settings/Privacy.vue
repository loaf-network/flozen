    ...
    <Card class="py-0 gap-0 overflow-hidden">
      <div class="flex items-center gap-4 px-4 py-3.5">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-xs text-muted-foreground mt-0.5">已阅读并同意《Loaf Network 隐私政策》与《Flozen 免责声明》</p>
        </div>
      </div>
      <Separator />
      <Label class="flex items-center gap-4 cursor-pointer px-4 py-3.5 hover:bg-accent/30 transition-colors">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-xs text-muted-foreground mt-0.5">匿名收集页面浏览与交互数据，用于改善产品体验</p>
        </div>
      </Label>
    </Card>
  </div>
